...
#include <iostream>
#include <fstream>  // Only works for C++11 and above 
#include <sstream>



void readCSV(const std::string& filename, LinkedList<Anime>& ll, DoublyLinkedList<Anime>& dll, Queue<Anime>& q, Stack<Anime>& s)
{
